...
class Benchmarker:
    ...
    def benchmark_model(
        self, name: str, model, X_train, y_train, X_test, y_test, cv: int = 5
    ) -> dict:
        """
    ...
    def run_full_benchmark(
        self, X, y, test_size: float = 0.2, val_size: float = 0.1
    ) -> pd.DataFrame:
        """
...
class DeploymentAnalyzer:
    ...
    def analyze_memory(self, models: dict) -> pd.DataFrame:
        ...
        for name, model in models.items():
            ...
            results.append({"model_name": name, "serialized_size_mb": size_mb})
        ...
        report = {
            ...
            "computational": {
                ...
                "inference_time_per_sample_ms": float(
                    best_model["inference_time_per_sample_ms"]
                ),
            },
            "recommendations": [],
        }
