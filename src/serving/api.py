...
try:
    from src.serving.fallback import FallbackChain, ChurnFallbackPredictor, FallbackMetrics
...
async def predict(request: PredictionRequest):
    ...
    if FALLBACK_AVAILABLE and fallback_chain:
        try:
            ...
            return PredictionResponse(
                ...
                churn_probability=float(result.probability) if result.probability else 0.5,
    ...
    try:
        ...
        logger.info(f"Prediction #{prediction_count} completed in {inference_time:.4f}s")
