...
class PredictionLogger:
    ...
    def log_batch(self, predictions: np.ndarray, probabilities: np.ndarray,
...
class ModelMonitor:
    ...
    def log_inference(self, features: np.ndarray, prediction: int, 
                      probability: float, ground_truth: int = None):
        """
...
def create_monitor_for_production(model_name: str, 
                                   X_reference: np.ndarray,
                                   baseline_metrics: dict) -> ModelMonitor:
    """
